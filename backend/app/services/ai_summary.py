...
_STRUCTURED_PROMPT = """Та Монгол хэлний мэргэжлийн редактор юм.
...
ШААРДЛАГА:
1. Утгаар нь ойлгомжтой орчуул
2. Монгол хүний уншихад байгалийн болго
3. Бүх дүрмийн алдааг зас
4. Өгүүлбэрийн найруулгыг зөв болго
5. Хэт урт өгүүлбэрийг задла
6. Давхардал, нуршууг арилгах

ДҮРЭМ:
- Монгол хэлний зөв бичих дүрмийг ягштал баримтал
- Том жижиг үсэг зөв
- Цэг, таслал зөв
- Албан, цэгцтэй хэл
...
def _parse_structured_response(text: str) -> dict | None:
    ...
    for line in text.split("\n"):
        ...
        for key in ("TITLE:", "SUMMARY:", "KEY_POINTS:", "FULL_TEXT:"):
