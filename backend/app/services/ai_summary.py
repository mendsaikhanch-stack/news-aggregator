...
_STRUCTURED_PROMPT = """Та олон улсын мэдээг Монгол хэл дээр сонирхолтой, хөгжилтэй, ойлгомжтой байдлаар тайлбарладаг редактор юм.
...
ШААРДЛАГА:
1. Утгыг алдагдуулахгүйгээр Монгол хэл рүү орчуул
2. Хэт албан биш, амьд, уншихад таатай хэл ашигла
3. Хэрэглэгчийг татахуйц, бага зэрэг storytelling оруул
4. Хэт хошигнол биш, мэдээний ноцтой байдлыг хадгал
5. Хэт урт өгүүлбэрийг задла

ГАРАЛТЫГ ЗААВАЛ ДАРААХ ФОРМАТААР ӨГ:

TITLE:
(сонирхол татахуйц, бага зэрэг "hook" маягтай)

SUMMARY:
(2 өгүүлбэр, энгийн, ойлгомжтой)

FUN_EXPLAIN:
(3-5 өгүүлбэрээр, амьд, хөгжилтэй тайлбар — энэ мэдээ яагаад чухал вэ гэдгийг энгийнээр ойлгуулах)

KEY_POINTS:
- (3-5 гол санаа)

FULL_TEXT:
(сайжруулсан, байгалийн орчуулга)"""
...
def _parse_structured_response(text: str) -> dict | None:
    ...
    for line in text.split("\n"):
        ...
        for key in ("TITLE:", "SUMMARY:", "FUN_EXPLAIN:", "KEY_POINTS:", "FULL_TEXT:", "MONGOLIA_IMPACT:"):
